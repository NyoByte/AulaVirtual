        ...
        <div class="row">
            <div class="col-auto">
                <div>
                    ...
                    <div class="form-row mb-3">
                        <div class="col">
                            <a class="btn btn-primary float-right" type="submit"><svg width="1.5em" height="1.5em"
                ...
                <div>
                    ...
                    <div class="form-row mb-3">
                        ...
                        <div class="col-auto">
                            <a class="btn btn-danger float-right" type="submit"><svg width="1.5em" height="1.5em"
                                    stroke="white" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Ingeniería</td>
                            <td>Female</td>
                            <td class="pl-4 ope-td"><a href="/aula_virtual/administrador/profesores/edit/${cod}"><svg
