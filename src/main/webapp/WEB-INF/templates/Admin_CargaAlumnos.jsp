    ...
    <div class="main-border">
        <div class="row">
            <div class="col-12">
                ...
                <div class="px-2">
                    <p class="mb-1">&nbsp</p>
                    <form action="/alumno/guardar_masivo" method="post" enctype="multipart/form-data">
                        <input type="file" name="file" id="input_file" onchange="handleFiles(this.files)" accept=".csv"
                            style="display: none">
                        <button class="btn btn-warning" id="boton_subir" type="submit"><svg width="2em" height="1.5em"
                                viewBox="0 0 16 16" class="bi bi-cloud-arrow-up-fill" fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
            ...
            <tbody>
                <c:forEach var="alumno" items="${listaAlumnos}">
                    <tr>
                        ...
                        <td class="pl-4 ope-td"><a href="/alumno?edit=true&alumno_id=${alumno.id}"><svg width="1em"
