...
<body class="fondo">
    ...
    <div class="main-border">
        <div class="row">
            <div class="col-12">
                <div>
                    <p class="font-weight-bold"><h2>Gestión de Alumnos</h2></p>
                </div>
                <div class="form-row mb-3">
                    ...
                    <div class="btn-group col-6 pl-3">
                        <div class="px-2">
                            <p class="mb-1">&nbsp</p>
                            <a class="btn btn-success" type="submit"><svg width="2em" height="1.5em" viewBox="0 0 16 16" class="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="px-2">
                            ...
                            <a class="btn btn-primary" type="submit"><svg width="2em" height="1.5em" viewBox="0 0 16 16" class="bi bi-file-earmark-code" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="px-2">
                            <p class="mb-1">&nbsp</p>
                            <a class="btn btn-warning" type="submit"><svg width="2em" height="1.5em" viewBox="0 0 16 16" class="bi bi-cloud-arrow-up-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="row">
                    <!--ultima linea-->
                    <div class="col">
                        <a class="btn btn-primary" type="button" href="/aula_virtual/administrador/alumnos/edit"><svg width="2em" height="2em" stroke="white" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
