                    ...
                    <c:forEach var="alumno" items="${listaAlumnos}">
                        <tr>
                            ...
                            <td id="boton_borrar" class="pl-4 ope-td">
                                <form action="/alumno_eliminar/${alumno.id}" method="POST"><button class="btn btn-link p-0 border-0" type="submit"
                    ...
                    <div class="row justify-content-around">
                        <c:if test="${pagActual>0}">
                            <a href="?page=0" id="boton_primera_pag">
                                <svg width="1em" height="1em" stroke="black" viewBox="0 0 16 16" class="bi bi-chevron-double-left"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                            ...
                            <a href="?page=${pagActual-1}" id="boton_pag_anterior">
                                <svg width="1em" height="1em" stroke="black" viewBox="0 0 16 16" class="bi bi-chevron-left"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                        ...
                        <c:if test="${pagActual<numPaginas-1}">
                            <a href="?page=${pagActual+1}" type="button" id="boton_sgte_pag">
                                <svg width="1em" height="1em" stroke="black" viewBox="0 0 16 16" class="bi bi-chevron-right"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                            ...
                            <a href="?page=${numPaginas-1}" id="boton_ultima_pag">
                                <svg width="1em" height="1em" stroke="black" viewBox="0 0 16 16" class="bi bi-chevron-double-right"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
