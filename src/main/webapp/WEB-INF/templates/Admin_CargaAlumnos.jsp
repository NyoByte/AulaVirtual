                    ...
                    <tbody>
                        <c:forEach var="alumno" items="${listaAlumnos}">
                            <tr>
                                ...
                                <td class="pl-4 ope-td"><a href="/alumno?edit=true&alumno_id=${alumno.id}"><svg width="1em" height="1em" viewBox="0 0 16 16"
                                ...
                                <td class="pl-4 ope-td"><a  href="/eliminar_alumno/${alumno.id}"
