...
<head>
    ...
    <title>AulaVirtual-Cursos</title>
        ...
        <div class="row">
            <div class="col-12">
                    ...
                    <tbody>
                        <c:forEach var="curso" items="${listaCursos}">
                            <tr>
                                ...
                                <td class="pl-4 ope-td"><a href="/curso?edit=true&curso_id=${curso.id}"><svg width="1em"
                                ...
                                <td id="boton_borrar" class="pl-4 ope-td">
                                    <form action="/curso/eliminar/${curso.id}" method="POST"><button
                ...
                <div class="row justify-content-between">
                    <!--ultima linea-->
                    <div class="col">
                        <a class="btn btn-primary" type="button" href="/curso?edit=true"><svg width="2em" height="2em"
