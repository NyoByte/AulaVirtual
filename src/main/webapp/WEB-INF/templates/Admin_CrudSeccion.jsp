                                ...
                                <div class="form-row mb-3">
                                    <div class="col">
                                        ...
                                        <input id="codigoProfesorT1" class="form-control" type="number" min="1"
                                            max="999999999" name="cod" readonly="true" value="" />
                                    </div>
                                    <div class="col">
                                ...
                                <div class="form-row mb-5">
                                    <div class="col">
                                        ...
                                        <input id="codigoProfesorT2" class="form-control" type="number" min="1"
                                            max="999999999" name="cod" readonly="true" />
                                    </div>
                                    <div class="col">
                                        <p class="mb-1">Nombre</p>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="boton_edit" class="pl-4 ope-td"><a
                                                href="?edit=true&alumno_id=${alumno.id}"><svg width="1em" height="1em"
                                                    viewBox="0 0 16 16" class="bi bi-pencil-fill" fill="currentColor"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd"
                        ...
                        <div class="col-auto">
                            ...
                            <div>
                                ...
                                <div class="form-row mb-3">
                                    <div class="col">
                                        <p class="mb-1">Código</p>
                                        <input class="form-control" type="number" min="1" max="999999999" name="cod" id="codigoProfesorT1"
                                            value="${profesorSeleccionadoT1.cod}" readonly="true" />
                                    </div>
                                    <div class="col">
                                        <p class="mb-1">Nombre</p>
                                        <select class="form-control" oninput="OnSelectProfesorT1()" id="profesorT1Seleccionado" name="profesorT1_name">
                                            <c:choose>
                                                <c:when test="${profesorSeleccionadoT1 != null}">
                                                    <option value="${profesorSeleccionadoT1.cod}"> ${profesorSeleccionadoT1.first_name} ${profesorSeleccionadoT1.last_name}</option>
                                                </c:when>
                                                <c:otherwise>
                                                    <option>Choose...</option>
                                                </c:otherwise>
                            ...
                            <div>
                                ...
                                <div class="form-row mb-5">
                                    <div class="col">
                                        <p class="mb-1">Código</p>
                                        <input class="form-control" type="number" min="1" max="999999999" name="cod" id="codigoProfesorT2"
                                            value="${profesorSeleccionadoT2.cod}" readonly="true" />
                                    </div>
                                    <div class="col">
                                        <p class="mb-1">Nombre</p>
                                        <select class="form-control" oninput="OnSelectProfesorT2()"
                                            ...
                                            <c:choose>
                                                <c:when test="${profesorSeleccionadoT2 != null}">
                                                    <option value="${profesorSeleccionadoT2.cod}"> ${profesorSeleccionadoT2.first_name} ${profesorSeleccionadoT2.last_name}</option>
                                                </c:when>
                                                <c:otherwise>
                                                    <option>Choose...</option>
                                                </c:otherwise>
