...
<body class="fondo">
    ...
    <c:choose>
        <c:when test="${profesor==null}">
            <form action="/profesor/guardar" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-9">
                            ...
                            <div class="form-row mb-3">
                                <div class="col">
                                    ...
                                    pattern="[a-zA-z0-9]+@aloe.ulima.edu.pe"
                                ...
                                <div class="form-row m-0">
                                    ...
                                    <div class="px-2">
                                        ...
                                        <button class="btn btn-success" id="boton_selec_foto" type="button"><svg width="2em" height="1.5em"
                                            ...
                                            <input type="file" name="image" id="input_foto" onchange="handleIMG(this.files), previewImage(event)"  accept="image/*" style="display: none">
                                    </div>
                                    <div class="px-2">
                                        <p class="mb-1">&nbsp</p>
                            ...
                            <div class="form-row mb-3">
                                <div class="col">
                                    ...
                                    <input class="form-control" type="email" maxlength="50" name="email_univ"
                                        value="${profesor.email_univ}" required pattern="[a-zA-z0-9]+@aloe.ulima.edu.pe"
                                        title="example: example@aloe.edu.pe"/>
                                </div>
                                <div class="col">
                                    <p class="mb-1">Correo Personal</p>
                                ...
                                <div class="form-row m-0">
                                    ...
                                    <div class="px-2">
                                        ...
                                        <button class="btn btn-success" id="boton_selec_foto" type="button"><svg width="2em" height="1.5em"
                                             ...
                                             <input type="file" id="input_foto" name="image" onchange="handleIMG(this.files), previewImage(event)"  accept="image/*" style="display: none">
                                    </div>
                                    <div class="px-2">
                                        <p class="mb-1">&nbsp</p>
                                        <button class="btn btn-warning" type="submit"><svg width="2em" height="1.5em"
